		...
		while (values.hasNextValue()) {
			...
			if (tripMap.get(value.trip_id) != null) {
				...
				try {
					...
					logger.debug("Incorrect stop time string: "+ Objects.toString(value));
					continue;
				}
...
//		return lt.getHour() * 60 + lt.getMinute();
	...
	public static class GTFSStopTime {
		public String trip_id, arrival_time, departure_time, stop_id, stop_sequence,shape_dist_traveled,stop_headsign,pickup_type,drop_off_type;
	}
	...
	public static class GTFSTrip {
		public String route_id, service_id,trip_id,trip_headsign, direction_id,shape_id,trip_short_name,block_id;
